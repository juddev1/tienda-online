...
<head>
  ...
  <style>
    ...
    .page-header {
      background-image: url('<?php echo BASE_URL; ?>assets/images/licoreria-bg.jpg');
    ...
    .bg-gradient-primary {
      background: linear-gradient(90deg, #f0134d, #ff6b6b);
    }
...
<body class="bg-gray-200">
  <main class="main-content  mt-0">
    <div class="page-header align-items-start min-vh-100" style="background-image: url('<?php echo BASE_URL; ?>assets/images/licoreria-bg.jpg');">
            ...
            <div class="card z-index-0 fadeIn3 fadeInBottom">
              <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                <div class="bg-gradient-primary shadow-primary border-radius-lg py-3 pe-1">
                  <h4 class="text-white font-weight-bolder text-center mt-2 mb-0">Acceso Admin</h4>
                  <p class="text-white text-center mb-0">Licorería Online</p>
                </div>
              </div>
              <div class="card-body">
